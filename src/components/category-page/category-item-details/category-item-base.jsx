    ...
    <div className={styles.item}>
      <Container>
        <AnimatedLink
          ...
          data-test='product-go-back-link'
        >
          Go back
        </AnimatedLink>
        <div className={styles.content}>
          <animated.div
            ...
            data-test='product-preview-image'
          >
          ...
          <div className={styles.info}>
            {newProduct && (
              <animated.span
                style={fromTopSpring}
                data-test='new-product-badge'
              >
                New product
              </animated.span>
            )}
            <animated.h2 style={fromRightSpring} data-test='product-name'>
              {arr[0]} <br /> {arr[1]}
            </animated.h2>
            <animated.p style={fromRightSpring} data-test='product-description'>
              {description}
            </animated.p>
